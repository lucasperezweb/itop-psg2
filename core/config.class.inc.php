...
define('ITOP_VERSION', '2.7.4'); // @see utils::GetItopVersionShort() and utils::GetItopVersionWikiSyntax()
define('ITOP_REVISION', '7194');
define('ITOP_BUILD_DATE', '2021-03-17 09:47:08');
